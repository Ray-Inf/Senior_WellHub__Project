This project is a web application made using React and Django designed to help senior citizens with booking appointments with doctors, manage medications, view local community event.
